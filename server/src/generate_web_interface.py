...
path_stream = '/home/kgrze/HoViStream/www/stream'
path_index_html = '/home/kgrze/HoViStream/www'
#path_index_html= '.'
index_html_name = 'index.html'
path_template = '.'
path_index_html_full = os.path.join(path_index_html, index_html_name)
...
html.write('\t\t<ul>\n')
for movie_name in os.listdir(path_stream):
    html.write('\t\t\t<li style="color:red;"><h2><a href="'+movie_name+'.html" style="color:red;">'+movie_name+'</a></h2></li>\n')
    path_movie_page = os.path.join(path_index_html, movie_name+'.html')
